    ...
    return (
        <Wrapper>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <circle cx="50" cy="50" r="0" fill="none" stroke="#5348c7" strokeWidth="1">
                    <animate attributeName="r" repeatCount="indefinite" dur="1s" values="0;42" keyTimes="0;1"
                ...
                <circle cx="50" cy="50" r="0" fill="none" stroke="#5747ff" strokeWidth="1">
                    <animate attributeName="r" repeatCount="indefinite" dur="1s" values="0;42" keyTimes="0;1"
